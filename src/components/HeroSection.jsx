...
const HeroSection = () => {
    ...
    const [gradient, setGradient] = useState('linear-gradient(180deg, #030C17, #0A223F)'); // Initial gradient
    ...
    const handleLogoClick = () => {
      ...
      setColor(prevColor =>
        prevColor === '#081120'
          ? '#0A1628'
          : '#081120' // Toggle back to the initial
        );
    };
  ...
  return (
    <div className="outer" style={{ background: gradient }}>
      ...
      <img src="innovision.svg" alt="inno" className="logo" onClick={handleLogoClick}  />
